...
const PostCard = ({ post, showActions = false, showAuthor = true, onEdit, onDelete, onDuplicate, className = "", }) => {
                    ...
                    <div className="flex items-start justify-between mt-5">
                        ...
                        {showActions && (
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent className="w-48 bg-black border-slate-700" align="end">
                                    {onEdit && (
                                        <DropdownMenuItem className="hover:bg-slate-800 cursor-pointer" onClick={() => onEdit(post._id)}>
                                            <Edit className="h-4 w-4 mr-2" />
                                            Edit Post
                                        </DropdownMenuItem>
                                    )}
                                    {publicUrl && (
                                        <DropdownMenuItem className="hover:bg-slate-800 cursor-pointer" asChild>
                                    ...
                                    {onDuplicate && (
                                        <DropdownMenuItem className="hover:bg-slate-800 cursor-pointer" onClick={() => onDuplicate(post)}>
                                    ...
                                    {onDelete && (
                                        <>
                                            ...
                                            <DropdownMenuItem
                                                ...
                                                className="text-red-400 hover:bg-slate-800 cursor-pointer focus:text-red-400"
                                            >
